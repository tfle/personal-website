...
<div id="roll">
  ...
  <button class="btn mr-2 mb-2" id="junior143">big fat pig<span style="display:none"></span></button>
  ...
  <button class="btn mr-2 mb-2" id="junior214">AAnthonyAnthonynthony<span style="display:none"></span></button>
  <button class="btn mr-2 mb-2" id="junior215">Oscar oscar hello my name is Bob<span style="display:none"></span></button>
  <!--
...
<div id="project-list">
  ...
  <button class="btn mr-2 mb-2" id="https://minecraft.makecode.com/#pub:_J6xbxDbKy2zt">tonymas</button>
  <!--
